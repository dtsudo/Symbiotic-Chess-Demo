...
let getKeyboard = function ({ disableArrowKeyScrolling, browserWindow, browserDocument }) {
    ...
    browserDocument.addEventListener("keydown", function (e) { keyDownHandler(e); }, false);
    browserDocument.addEventListener("keyup", function (e) { keyUpHandler(e); }, false);
    browserWindow.addEventListener("blur", function () { onBlur(); });
