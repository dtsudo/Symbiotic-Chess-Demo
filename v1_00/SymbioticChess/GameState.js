...
let serializeGameState = function (gameState) {
    ...
    byteListBuilder.addNullableInt(gameState.customOpponentSkillLevel);
...
let deserializeGameState = function (serializedGameState) {
    ...
    let customOpponentSkillLevel = byteListIterator.popNullableInt();
...
let processAskStockfishPower = function ({ gameState }) {
    ...
    return {
        ...
        customOpponentSkillLevel: gameState.customOpponentSkillLevel,
...
let getInitialGameState = function ({ isPlayerWhite, numAskStockfishPower, numGetEvalPower, numGetOpponentResponsePower, numGetPieceToMovePower, opponent, customOpponentSkillLevel }) {
    return {
        ...
        previousMoves: [],
        opponent: opponent,
        customOpponentSkillLevel: customOpponentSkillLevel,
