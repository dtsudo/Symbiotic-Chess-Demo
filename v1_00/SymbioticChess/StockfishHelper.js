...
let getStockfishHelper = function ({ stockfishLocation, stockfishSkillLevel }) {
    ...
    if (stockfishSkillLevel !== null)
        postMessage("setoption name Skill Level value " + stockfishSkillLevel);
    postMessage("isready");
    ...
    return {
        getSkillLevel: function () { return stockfishSkillLevel; },
        getBestMove,
